...
`{pkgtemp}` contains as series of [`usethis`](https://usethis.r-lib.org/index.html) and other commands in an **R Markdown** that provides a recipe to *kick-start* your R package development process.

## Prerequisites

`pkgtemp` will facilitate your R package development process. However, you should be somewhat familiar with how to create R Package.
...
-   [**Build Package Template:**](./inst/rmarkdown/templates/build-pkg/skeleton/skeleton.Rmd) contains a set of R functions to run in each step of package development.
...
-   Write and open R Markdown file `dev/build.Rmd` which is a template for developing your R package.

1.  Go to [**`build.Rmd`**](./inst/rmarkdown/templates/build-pkg/skeleton/skeleton.Rmd) file. You will see 2 types of command in there:
